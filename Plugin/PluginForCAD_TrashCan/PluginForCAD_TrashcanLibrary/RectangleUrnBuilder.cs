    ...
    public class RectangleUrnBuilder
    {
        ...
        public void Build(Parameters parameters)
        {
            ...
            #region эскиз для крепления ножек стойки
                ...
                _lineParam.x2 = 0.5 * 10;
                _lineParam.y1 = parameters.RadiusBottom + 1 * 10;
                _lineParam.y2 = parameters.RadiusBottom - Math.Abs(parameters.RadiusBottom - parameters.RadiusTop);
                _lineParam.style = 1;
                Document2DStandBracing.ksLineSeg(_lineParam.x1, _lineParam.y1, _lineParam.x2, _lineParam.y2, _circleParam.style);
                _lineParam.x1 = 0.5 * 10;
                _lineParam.x2 = 6.5 * 10;
                _lineParam.y1 = parameters.RadiusBottom - Math.Abs(parameters.RadiusBottom - parameters.RadiusTop);
                _lineParam.y2 = parameters.RadiusBottom - Math.Abs(parameters.RadiusBottom - parameters.RadiusTop);
                _lineParam.style = 1;
                Document2DStandBracing.ksLineSeg(_lineParam.x1, _lineParam.y1, _lineParam.x2, _lineParam.y2, _circleParam.style);
                _lineParam.x1 = 6.5 * 10;
                _lineParam.x2 = 6.5 * 10;
                _lineParam.y1 = parameters.RadiusBottom - Math.Abs(parameters.RadiusBottom - parameters.RadiusTop);
                _lineParam.y2 = parameters.RadiusBottom - 10 - Math.Abs(parameters.RadiusBottom - parameters.RadiusTop);
                _lineParam.style = 1;
                Document2DStandBracing.ksLineSeg(_lineParam.x1, _lineParam.y1, _lineParam.x2, _lineParam.y2, _circleParam.style);
                _lineParam.x1 = 6.5 * 10;
                _lineParam.x2 = 0.5 * 10;
                _lineParam.y1 = parameters.RadiusBottom - 10 - Math.Abs(parameters.RadiusBottom - parameters.RadiusTop);
                _lineParam.y2 = parameters.RadiusBottom - 10 - Math.Abs(parameters.RadiusBottom - parameters.RadiusTop);
                _lineParam.style = 1;
                Document2DStandBracing.ksLineSeg(_lineParam.x1, _lineParam.y1, _lineParam.x2, _lineParam.y2, _circleParam.style);
